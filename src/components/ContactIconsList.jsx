...
const MOCKDATA = [
  { title: "Email", description: "hello@fuel.dev", icon: At },
  { title: "Phone", description: "+919645116496", icon: Phone },
  { title: "Address", description: "TKMIT Kollam", icon: MapPin },
  { title: "Working hours", description: "7 a.m. – 11 p.m.", icon: Sun },
];
